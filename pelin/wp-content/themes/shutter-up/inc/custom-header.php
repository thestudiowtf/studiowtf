				...
				?>
					...
					<?php if ( $header_media_url_text ) : ?>
						<span class="site-header-button">
							<a href="<?php echo esc_url( $header_media_url ); ?>" target="<?php echo get_theme_mod( 'shutter_up_header_url_target' ) ? '_blank' : '_self'; ?>" class="button"><?php echo esc_html( $header_media_url_text ); ?><span class="screen-reader-text"><?php echo wp_kses_post( $header_media_url_text ); ?></span></a>
						</span>
					<?php endif; ?>
				<?php endif; ?>
